...
function $47b4a70d4572a3b3$var$__init() {
    $47b4a70d4572a3b3$var$__init = (0, (/*@__PURE__*/$parcel$interopDefault($f653aaea2ce76311$exports)))((0, (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports))).mark(function _callee(props) {
        var emojiVersion, set, locale, alias, emojiId, emoji, alias1, emojiId1, emoji1, i, category, prevCategory, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, emoji2, latestVersionSupport, noCountryFlags, categoryIndex, resetSearchIndex, category1, maxFrequentRows, perLine, categoryIcons, icon, emojiIndex, emojiId2, emoji3, ignore, _iteratorNormalCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, emoticon, skinIndex, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, skin, native, skinShortcodes;
        return (0, (/*@__PURE__*/$parcel$interopDefault($f5fc4923ef4118c4$exports))).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    ...
                    if (!(!$47b4a70d4572a3b3$export$2d0294657ab35f1b && !props.data)) {
                        _ctx.next = 36;
                        break;
                    }
                ...
                case 44:
                    ...
                    $47b4a70d4572a3b3$export$2d0294657ab35f1b = _ctx.t4;
                    $47b4a70d4572a3b3$export$2d0294657ab35f1b.emoticons = {};
                    $47b4a70d4572a3b3$export$2d0294657ab35f1b.natives = {};
                    if (!$47b4a70d4572a3b3$export$2d0294657ab35f1b.categories.find(function(c) {
                        return c.id === "frequent";
                    })) $47b4a70d4572a3b3$export$2d0294657ab35f1b.categories.unshift({
                        id: "frequent",
                        emojis: []
                    });
                    _ctx.t5 = regeneratorRuntime.keys($47b4a70d4572a3b3$export$2d0294657ab35f1b.aliases);
                case 49:
                    if ((_ctx.t6 = _ctx.t5()).done) {
                        _ctx.next = 59;
                        break;
                    }
                    alias1 = _ctx.t6.value;
                    emojiId1 = $47b4a70d4572a3b3$export$2d0294657ab35f1b.aliases[alias1];
                    emoji1 = $47b4a70d4572a3b3$export$2d0294657ab35f1b.emojis[emojiId1];
                    if (emoji1) {
                        _ctx.next = 55;
                        break;
                    }
                    return _ctx.abrupt("continue", 49);
                case 55:
                    emoji1.aliases || (emoji1.aliases = []);
                    emoji1.aliases.push(alias1);
                    _ctx.next = 49;
                    break;
                case 59:
                    $47b4a70d4572a3b3$export$2d0294657ab35f1b.originalCategories = $47b4a70d4572a3b3$export$2d0294657ab35f1b.categories;
                ...
                case 62:
                    {
                        ...
                        $47b4a70d4572a3b3$export$2d0294657ab35f1b.categories = $47b4a70d4572a3b3$export$2d0294657ab35f1b.originalCategories ? (0, (/*@__PURE__*/$parcel$interopDefault($768065e6069a057e$exports)))($47b4a70d4572a3b3$export$2d0294657ab35f1b.originalCategories) : $47b4a70d4572a3b3$export$2d0294657ab35f1b.categories;
                ...
                case 70:
                    ...
                    _ctx.t9 = (0, (/*@__PURE__*/$parcel$interopDefault($128a97276525cf7f$exports)));
                    _ctx.next = 79;
                    break;
                case 76:
                    _ctx.next = 78;
                ...
                case 79:
                    _ctx.t7 = _ctx.t9;
                case 80:
                    $47b4a70d4572a3b3$export$dbe3113d60765c1a = _ctx.t7;
                    if (!props.custom) {
                        _ctx.next = 113;
                        break;
                    }
                    _ctx.t10 = regeneratorRuntime.keys(props.custom);
                case 83:
                    if ((_ctx.t11 = _ctx.t10()).done) {
                        _ctx.next = 113;
                        break;
                    }
                    i = _ctx.t11.value;
                    ...
                    return _ctx.abrupt("continue", 83);
                case 90:
                    ...
                    for(_iterator = category.emojis[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                        emoji2 = _step.value;
                        $47b4a70d4572a3b3$export$2d0294657ab35f1b.emojis[emoji2.id] = emoji2;
                    }
                    _ctx.next = 103;
                    break;
                case 99:
                    _ctx.prev = 99;
                    _ctx.t12 = _ctx["catch"](95);
                    _didIteratorError = true;
                    _iteratorError = _ctx.t12;
                case 103:
                    _ctx.prev = 103;
                    _ctx.prev = 104;
                    if (!_iteratorNormalCompletion && _iterator.return != null) {
                ...
                case 106:
                    ...
                    throw _iteratorError;
                case 109:
                    return _ctx.finish(106);
                case 110:
                    return _ctx.finish(103);
                case 111:
                    _ctx.next = 83;
                    break;
                case 113:
                ...
                case 119:
                    ...
                    return _ctx.abrupt("continue", 119);
                case 125:
                ...
                case 128:
                    ...
                    emojiId2 = category1.emojis[emojiIndex];
                    emoji3 = emojiId2.id ? emojiId2 : $47b4a70d4572a3b3$export$2d0294657ab35f1b.emojis[emojiId2];
                    ignore = function() {
                        category1.emojis.splice(emojiIndex, 1);
                    };
                    if (!(!emoji3 || props.exceptEmojis && props.exceptEmojis.includes(emoji3.id))) {
                        _ctx.next = 135;
                        break;
                    }
                    ignore();
                ...
                case 135:
                    if (!(latestVersionSupport && emoji3.version > latestVersionSupport)) {
                        _ctx.next = 138;
                        break;
                    }
                    ignore();
                ...
                case 138:
                    ...
                    if ((0, $fc6326626d221acf$export$bcb25aa587e9cb13).includes(emoji3.id)) {
                        _ctx.next = 142;
                        break;
                    }
                    ignore();
                ...
                case 142:
                    ...
                    _ctx.prev = 147;
                    _iterator1 = emoji3.emoticons[Symbol.iterator]();
                case 149:
                    ...
                    return _ctx.abrupt("continue", 154);
                case 153:
                    $47b4a70d4572a3b3$export$2d0294657ab35f1b.emoticons[emoticon] = emoji3.id;
                case 154:
                ...
                case 159:
                    _ctx.prev = 159;
                    _ctx.t13 = _ctx["catch"](147);
                    _didIteratorError1 = true;
                    _iteratorError1 = _ctx.t13;
                case 163:
                    _ctx.prev = 163;
                    _ctx.prev = 164;
                ...
                case 170:
                    return _ctx.finish(163);
                case 171:
                    skinIndex = 0;
                    _iteratorNormalCompletion2 = true, _didIteratorError2 = false, _iteratorError2 = undefined;
                    _ctx.prev = 173;
                    _iterator2 = emoji3.skins[Symbol.iterator]();
                case 175:
                    ...
                    return _ctx.abrupt("continue", 184);
                case 179:
                    skinIndex++;
                    native = skin.native;
                    if (native) {
                        $47b4a70d4572a3b3$export$2d0294657ab35f1b.natives[native] = emoji3.id;
                        emoji3.search += ",".concat(native);
                    }
                    skinShortcodes = skinIndex == 1 ? "" : ":skin-tone-".concat(skinIndex, ":");
                    skin.shortcodes = ":".concat(emoji3.id, ":").concat(skinShortcodes);
                case 184:
                ...
                case 189:
                    _ctx.prev = 189;
                    _ctx.t14 = _ctx["catch"](173);
                    _didIteratorError2 = true;
                    _iteratorError2 = _ctx.t14;
                case 193:
                    _ctx.prev = 193;
                    _ctx.prev = 194;
                ...
                case 199:
                    return _ctx.finish(196);
                case 200:
                    return _ctx.finish(193);
                case 201:
                    _ctx.next = 128;
                    break;
                case 203:
