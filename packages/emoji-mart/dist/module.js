...
async function $7adb23b0109cc36a$var$_init(props) {
    ...
    if (!$7adb23b0109cc36a$export$2d0294657ab35f1b && !props.data) {
        ...
        $7adb23b0109cc36a$export$2d0294657ab35f1b = typeof props.data === "function" ? await props.data() : props.data;
        $7adb23b0109cc36a$export$2d0294657ab35f1b.emoticons = {};
        $7adb23b0109cc36a$export$2d0294657ab35f1b.natives = {};
        if (!$7adb23b0109cc36a$export$2d0294657ab35f1b.categories.find((c)=>c.id === "frequent")) $7adb23b0109cc36a$export$2d0294657ab35f1b.categories.unshift({
            id: "frequent",
            emojis: []
        });
        for(const alias in $7adb23b0109cc36a$export$2d0294657ab35f1b.aliases){
        ...
        $7adb23b0109cc36a$export$2d0294657ab35f1b.categories = $7adb23b0109cc36a$export$2d0294657ab35f1b.originalCategories ? [
